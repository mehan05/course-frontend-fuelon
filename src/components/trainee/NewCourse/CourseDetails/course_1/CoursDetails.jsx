      ...
      <form className="w-full max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex flex-col gap-4 items-start hover:transition hover:duration-200 hover:scale-[1.01]">
          ...
          <label htmlFor="image-upload" className="w-full cursor-pointer">
            <div className="w-full border-4 border-dashed rounded-lg border-violet-400 p-8 md:p-16 flex justify-center items-center">
              <img
                src="/galleryimg.png"
                alt="Upload"
        ...
        <Link
          to="modules"
          className="fixed bottom-4 right-4 bg-violet-500 px-4 py-2 text-center text-white rounded-lg font-semibold w-[100px] hover:bg-white hover:border-2 hover:border-violet-500 hover:text-violet-500 transition duration-300"
        >
          Next
        </Link>
      </form>
